        ...
        "tables": [
            # -------- matchup_facts ----------------------------------------
            {
                ...
                "columns": [
                    ...
                    _col("TourneyRound",        "string"),
                    _col("TourneyRoundOrder",   "int64"),
                    _col("T1_ConfAbbrev",       "string"),
                    _col("T1_Conference",       "string"),
                    _col("T2_ConfAbbrev",       "string"),
                    _col("T2_Conference",       "string"),
                ],
                "measures": [
                    _measure(
                        "Avg Point Margin",
                ...
                "partitions": [
                    {
                        ...
                        "source": {
                            ...
                            "expression": [
                                "let",
                                '    Source = Csv.Document(File.Contents(_DataFolder & "matchup_facts.csv"),[Delimiter=",", Columns=28, Encoding=65001, QuoteStyle=QuoteStyle.None]),',
                                ...
                                '        {"Seed_diff", type number}, {"PointDiff", type number},',
                                '        {"Upset", Int64.Type}, {"T1_quality", type number},',
                                '        {"T2_quality", type number}, {"T1_AvgRank", type number},',
                                '        {"T2_AvgRank", type number}, {"AvgRank_diff", type number},',
                                '        {"TourneyRoundOrder", Int64.Type}, {"IsMensTeam", Int64.Type}',
                                "    })",
                                "in",
                                "    #\"Changed Types\"",
                            ],
            ...
            # -------- team_season_stats ------------------------------------
            {
                ...
                "columns": [
                    ...
                    _col("quality",       "double"),
                    _col("AvgRank",       "double"),
                    _col("ConfAbbrev",    "string"),
                    _col("ConferenceName","string"),
                ],
                "measures": [
...
page1_visuals = [
    ...
    _slicer(10, 80,  200, 110, "matchup_facts", "TourneyRound", "Round",   "vertical",   "slicer_Round"),
    _slicer(10, 200, 200, 150, "matchup_facts", "T1_TeamName",  "Team 1",  "vertical",   "slicer_T1"),
    _slicer(10, 360, 200, 150, "matchup_facts", "T2_TeamName",  "Team 2",  "vertical",   "slicer_T2"),
    _slicer(10, 520, 200, 150, "matchup_facts", "T1_Conference","Conference","vertical", "slicer_Conf"),
    # KPI cards (top row)
...
page2_visuals = [
    ...
    _clustered_bar(
        730, 10, 530, 260,
        "bar_upset_round", "Upset Rate by Tournament Round",
        "matchup_facts", "TourneyRound",
        "matchup_facts", ["Upset Rate"],
    ),
...
page3_visuals = [
    ...
    _slicer(10,  70, 220, 100, "predicted_matchups", "T1_Conference","Conference", "vertical",   "slicer_Conf3"),
    _slicer(10, 180, 220, 250, "predicted_matchups", "T1_TeamName",  "Team 1",     "vertical",   "slicer_T1_pred"),
    _slicer(10, 440, 220, 250, "predicted_matchups", "T2_TeamName",  "Team 2",     "vertical",   "slicer_T2_pred"),
